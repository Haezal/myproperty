...
<?php echo CHtml::openTag('div', $this->htmlOptions); ?>
    ...
    <div class="btn-toolbar gform">
        ...
        <div class="btn-group">
            ...
            <span class="btn disabled remove_selected"><span class="glyphicon glyphicon-trash"></span> <?php echo Yii::t('galleryManager.main', 'Remove');?></span>
        </div>
    </div>
    <hr/>
    <!-- Gallery Photos -->
    ...
    <div class="modal fade editor-modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
