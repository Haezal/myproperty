(function ($) {
    ...
    function galleryManager(el, options) {
        ...
        if (opts.hasName || opts.hasDesc)photoTemplate += '<span class="editPhoto btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></span> ';
        photoTemplate += '<span class="deletePhoto btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></span>' +
